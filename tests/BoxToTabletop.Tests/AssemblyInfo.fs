...
[<assembly: AssemblyTitleAttribute("BoxToTabletop.Tests")>]
[<assembly: AssemblyProductAttribute("BoxToTabletop")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "BoxToTabletop.Tests"
    let [<Literal>] AssemblyProduct = "BoxToTabletop"
